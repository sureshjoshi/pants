...
The `[dockerfile-parser].use_rust_parser` was introduced in 2.25 and defaulted to true in 2.27. It has been removed, along with the `[dockerfile-parser]` field entirely. The Dockerfile parser is now entirely managed within the Pants engine.
